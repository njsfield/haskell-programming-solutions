...
/* package chex-0.1.0.0 */
#define VERSION_chex "0.1.0.0"
#define MIN_VERSION_chex(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "chex-0.1.0.0-KgUEtLxuEyGCiEynp3TqoJ"

#define CURRENT_PACKAGE_KEY "chex-0.1.0.0-KgUEtLxuEyGCiEynp3TqoJ"
